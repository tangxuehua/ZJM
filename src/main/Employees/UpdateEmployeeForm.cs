...
namespace NetFocus.MagzineSubscribe.UI
{
	...
	public class UpdateEmployeeForm : System.Windows.Forms.Form
	{
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(UpdateEmployeeForm));
		...
		private void button1_Click(object sender, System.EventArgs e)
		{
			...
			int i = EmployeeManager.UpdateEmployee(Int32.Parse(this.comboBox1.SelectedValue.ToString()),this.textBox1.Text.Trim());
			if(i == -1)
			{
		...
		private void UpdateEmployeeForm_Load(object sender, System.EventArgs e)
		{
			BindToComboBox();
		}
	}
